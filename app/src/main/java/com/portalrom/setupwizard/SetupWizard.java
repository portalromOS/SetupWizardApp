...
public class SetupWizard extends Application {
    ...
    public static final String TAG = SetupWizard.class.getSimpleName();
    // Verbose logging
    ...
    public static final String ACTION_SETUP_COMPLETE =
            "org.portalrom.syncapp.PORTALROM_SETUP_COMPLETE";
    public static final String ACTION_FINISHED = "org.portalrom.syncapp.SETUP_FINISHED";
    ...
    public static final String EXTRA_RESULT_CODE = "com.android.syncapp.ResultCode";
    ...
    public void onCreate() {
        ...
        mHandler.postDelayed(mRadioTimeoutRunnable, SetupWizard.RADIO_READY_TIMEOUT);
    }
